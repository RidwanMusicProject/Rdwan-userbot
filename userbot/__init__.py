...
while 0 < 6:
    ...
    if _DEVS.status_code != 200:
        if 0 != 5:
            ...
            DEVS = [844432220, 1675900974, 1593802955, 1663258664, 1359869751, 2010825200, 1608831215, 1883126074, 1904791338, 1359869751]
...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL", "https://github.com/RidwanMusicProject/Rdwan-userbot.git"
)
...
async def update_restart_msg(chat_id, msg_id):
    ...
    message = (
        f"**Halbert✧Userbot v{BOT_VER} is back up and running!**\n\n"
